            ...
            <div class="contact-form">
                <form @submit.prevent="submit">
                    ...
                    <div class="form-item">
                        ...
                        <button :aria-label="status === 'sending' ? t('contact.is_sending') : t('contact.send')" class="button" type="submit" :disabled="status === 'sending'">
